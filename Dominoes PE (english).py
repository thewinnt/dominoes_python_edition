...
##                pygame.draw.rect(window, theme_default[1], (24+((i)*59), 584, 55, 111))
    ...
    playerdata1 = font_pd.render((p1_name + " - " + str(p1_score) + " points, " + str(p1_wins) + " victories"), 4, current_theme[11], current_theme[9])
    ...
    playerdata2 = font_pd.render((p2_name + " - " + str(p2_score) + " points, " + str(p2_wins) + " victories"), 4, current_theme[11], current_theme[9])
