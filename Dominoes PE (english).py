...
pygame.display.set_caption("Dominoes: Python Edition v. Beta 1.7 pre-release 1 (English version)")
game_version = "v. Beta 1.7-pre1 (English version)"
...
class ui: # the game's GUI
    def __init__(self, surface, init=True):
        ...
        self.btn_play = ui_tools.Button(self.surface, 480, 390, 320, 55, font_d60, "Play", current_theme[14], current_theme[12], current_theme[13], current_theme[15], current_theme[0])
        self.btn_settings = ui_tools.Button(self.surface, 480, 455, 320, 55, font_d60, "Settings", current_theme[14], current_theme[12], current_theme[13], current_theme[15], current_theme[0])
        self.btn_how_to_play = ui_tools.Button(self.surface, 480, 520, 155, 55, font_d60, "Tutorial", current_theme[14], current_theme[12], current_theme[13], current_theme[15], current_theme[0])
        self.btn_exit = ui_tools.Button(self.surface, 645, 520, 155, 55, font_d60, 'Exit', current_theme[14], current_theme[12], current_theme[13], current_theme[15], current_theme[0])
        ...
        self.btn_gm_internet = ui_tools.Button(self.surface, 250, 500, 300, 55, font_d60, "In development...", current_theme[14], current_theme[12], current_theme[13], current_theme[16], current_theme[0])
        ...
        self.go_set_theme = ui_tools.Hyperlink(self.surface, 40, 476, '§nTheme settings', font_d60, current_theme[15])
        self.go_menu = ui_tools.Hyperlink(self.surface, 50, 66, '§n< Back', font_d60, current_theme[15])
        self.exit_game = ui_tools.Button(self.surface, 1040, 630, 200, 50, font_d60, 'Main menu', current_theme[14], current_theme[12], current_theme[13], current_theme[15], current_theme[0])
    ...
    def game_ren(self, custom_board=None):
        ...
        playerdata1 = font_pd.render((self.game.get_player(1)['name'] + " - " + str(self.game.get_player(1)['score']) + " points, " + str(self.game.get_player(2)['victories']) + " побед"), 4, current_theme[15], current_theme[13])
        ...
        playerdata2 = font_pd.render((self.game.get_player(2)['name'] + " - " + str(self.game.get_player(2)['score']) + " points, " + str(self.game.get_player(2)['victories']) + " побед"), 4, current_theme[15], current_theme[13])
    ...
    def next_player(self, current_move, player_count, fastmode):
        if not fastmode:
            ...
            line2 = font_gm_sel.render("Press Space or the OK button", 4, current_theme[15])
            sl2 = font_gm_sel.size("Press Space or the OK button")
            line3 = font_gm_sel.render("and make your move.", 4, current_theme[15])
            sl3 = font_gm_sel.size("and make your move.")
    ...
    def game_setup(self):
        ...
        error_messages = ["\n",
                        ...
                        "Players cannot have over 14 dominoes\n"
                        ]
        ...
        txt_score_limit = font_setup.render("Score to lose (aka score limit)", 4, current_theme[15])
        ...
        txt_begin_with_double = font_setup.render("Start a new game wwith a double", 4, current_theme[15])
